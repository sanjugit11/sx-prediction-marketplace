...
export interface PredictionMarketUnverifiedInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "accessControl"
      | "claim"
  ...
  getEvent(
    nameOrSignatureOrTopic: "Initialized" | "MarketResolved" | "Staked"
  ): EventFragment;
...
export interface PredictionMarketUnverified extends BaseContract {
  connect(runner?: ContractRunner | null): PredictionMarketUnverified;
  waitForDeployment(): Promise<this>;

  interface: PredictionMarketUnverifiedInterface;
